...
export class TableChartComponent extends ChartAbstract<DashboardCharts.ITableChartOptions> {
  ...
  constructor(tables: TableService, models: ModelService, experiments: ExperimentService, bus: CrossFilterBus, el: ElementRef, events: EventService) {
    super(tables, models, experiments, bus, el, events);
  }
