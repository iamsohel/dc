...
export class ScatterPlotChartOptionsComponent extends ChartOptionsAbstract {
  ...
  readonly gammas = AppSelectOptionData.fromList(config.chart.options.scatterPlotGamma.list, config.chart.options.scatterPlotGamma.labels);
  ...
  constructor() {
    ...
    this.form = new FormGroup({
      ...
      gamma: new FormControl(DashboardCharts.ScatterPlotChartGamma.PURE),
    });
  }
}
