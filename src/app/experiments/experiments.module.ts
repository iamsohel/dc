...
import { ExecutionTargetSelectorComponent } from './execution-target-selector.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ExperimentInteractiveContextComponent,
    ExecutionTargetSelectorComponent,
  ],
  exports: [
    ExperimentCreateComponent,
    ExperimentViewComponent,
            ...
            return {
              ...
              actions: {
                interactive: {
                  ...
                  title: 'Edit experiment pipeline',
                  isAvailable: (item: IExperimentFull) =>
                    item.status === IExperiment.Status.RUNNING && item.isInteractive,
                },
              },
