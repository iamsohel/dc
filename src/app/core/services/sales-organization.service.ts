...
import { IPmeSearchParams, ISalesOrganization } from '../../pme/pme.interfaces';
...
export class SalesOrganizationService {
  ...
  list(params?: IPmeSearchParams): Observable<IBackendList<ISalesOrganization>> {
    return this.http.getpme('salesorganizations', params);
  }
