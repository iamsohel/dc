...
import { ICustomer, IPmeSearchParams } from '../../pme/pme.interfaces';
...
export class CustomerService {
  ...
  list(params?: IPmeSearchParams): Observable<IBackendList<ICustomer>> {
    return this.http.getpme('customerMasters', params);
  }
