...
import { IPmeSearchParams, ISalesDistrict } from '../../pme/pme.interfaces';
...
@Injectable()
export class SalesDistrictService {
  ...
  list(params?: IPmeSearchParams): Observable<IBackendList<ISalesDistrict>> {
    return this.http.getpme('salesdistricts', params);
  }
