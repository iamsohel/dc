...
import { IMaterail, IPmeSearchParams } from '../../pme/pme.interfaces';
...
export class MaterialService {
  ...
  list(params?: IPmeSearchParams): Observable<IBackendList<IMaterail>> {
    return this.http.getpme('materials/', params);
  }
