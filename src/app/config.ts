...
import { IDCProject, IDCProjectSession } from './develop/dc-project.interfaces';
...
const api = {
  ...
  'cor-771.exp.deepcortex.ai': 'http://develop.exp.deepcortex.ai/api/insilico/v1.4/',
  '192.168.1.234': 'http://192.168.1.144:9000/api/insilico/v1.4/',
  'localhost': 'http://app.huntsman.deepcortex.ai/baile/v2.0/',
  // 'pme': 'https://pme-backend-deployment-dev.azurewebsites.net/api/',
  //'pme': 'https://test-api-pme-quotation.azurewebsites.net/api/',
   'pme': 'http://10.202.21.12/api/',
  // Demo:
  'demo.dev.deepcortex.ai.s3-website-us-east-1.amazonaws.com': 'http://deepcortex-dev-baile-elb-162323589.us-east-1.elb.amazonaws.com/baile/v2.0/',
...
const config = {
  api: {
    ...
    pmeTokenValue: token => 'Token ' + token,
  ...
  chart: {
    ...
    options: {
      ...
      scatterPlotGamma: describeEnum(DashboardCharts.ScatterPlotChartGamma, {
        labels: {
          'SPECTRAL': 'Spectral',
          'PURE': 'Pure',
          'REDBLACKGREEN': 'Red Black Green',
          'VIRIDIS': 'Viridis',
        },
      }),
    },
  ...
  model: {
    status: describeEnum(IModel.Status, {
      labels: {
        ACTIVE: 'Active',
        IMPORTING: 'Importing',
        ERROR: 'Error',
    ...
    job: {
      type: describeEnum(IProcess.JobType, {
        labels: {
          ...
          'PROJECT_BUILD': 'DC Project Building',
        ...
        mockOnly: {
          ...
          'TABULAR_PREDICT': true,
          'TABULAR_TRAIN': true,
          'TABULAR_EVALUATE': true,
          'TABULAR_COLUMN_STATISTICS': true,
  ...
  dcProject: {
    status: describeEnum(IDCProject.Status, {
      labels: {
        IDLE: 'Idle',
        BUILDING: 'Building',
    ...
    sessionStatus: describeEnum(IDCProjectSession.Status, {
      labels: {
        QUEUED: 'Preparing...',
        SUBMITTED: 'Preparing...',
        RUNNING: 'Ready',
  ...
  //-- PME
  pmeitem: {
    status: describeEnum(IPriceRecord.Status, {
      labels: {
        INSERT_REQUESTED_SELLING_PRICE: 'Insert Requested Selling Price',
        REVIEW_REQUESTED_SELLING_PRICE_CD: 'Review Requested Selling Price - CD',
        REVIEW_REQUESTED_SELLING_PRICE_SM: 'Review Requested Selling Price - SM',
        REVIEW_REQUESTED_SELLING_PRICE_GMM: 'Review Requested Selling Price - GMM',
        REVIEW_REQUESTED_SELLING_PRICE_REJECTED_CD: 'Review Rejected Price - CD',
        REVIEW_REQUESTED_SELLING_PRICE_REJECTED_SM: 'Review Rejected Price - SM',
        REVIEW_REQUESTED_SELLING_PRICE_REJECTED_SR: 'Review Rejected Price - SR',
        VALIDATED_PRICE: 'Validated Price',
      },
    }),
    priority: describeEnum(IPriceRecord.Priority, {
      labels: {
        P1: 'High',
        P2: 'Medium',
        P3: 'Low',
        AUTO_EXTENDED: 'Auto Extension',
      },
    }),
    productType: describeEnum(IPriceRecord.ProductType, {
      labels: {
        VBM: 'VBM',
        MTO: 'MTO',
      },
    }),
    recordType: describeEnum(IPriceRecord.RecordType, {
      labels: {
        DVP: 'DVP',
        QUOTE: 'QUOTE',
      },
  ...
  gridLicense: 'CompanyName=Sentrana Inc,LicensedApplication=DeepCortex,LicenseType=SingleApplication,LicensedConcurrentDeveloperCount=1,LicensedProductionInstancesCount=0,AssetReference=AG-017357,ExpiryDate=14_July_2022_[v2]_MTY1Nzc1MzIwMDAwMA==83ea2b792aa60df60e615e8d9a5235ad',
};
