...
export class CVModelCreateComponent implements OnInit, OnDestroy, IExperimentPipelineForm<ICVTLTrainPipeline> {
  ...
  public getPipeline(): Observable<ICVTLTrainPipeline> {
    return of(this.getPipelineDataToSubmit());
  }
