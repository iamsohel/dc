  ...
  },
  {
    ...
    handler: function(this, params, user) {
      ...
      return {
        ...
        projectsCount: this.resultsetByScope(this.collections.projects, IAsset.Type.DC_PROJECT, 'all', user).count(),
        ...
        dcProjectsCount: this.resultsetByScope(this.collections.dcProjects, IAsset.Type.DC_PROJECT, 'all', user).count(),
      };
    },
  },
  {
