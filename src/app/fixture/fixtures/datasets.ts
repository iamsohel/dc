...
export const datasets: {
  ...
  data: [
    ...
    },
    {
      ...
      csvPath: 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/boston_prices_new.csv',
      data: [],
      count: 0,
    },
    {
      id: 'AIRTF_all_data_cleaned2_',
      csvPath: 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/AIRTF_all_data_cleaned2_100000.csv',
      data: [],
      count: 0,
    },
    {
      id: 'abbv_ticker',
      csvPath: 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/abbv_ticker.csv',
      data: [],
      count: 0,
    },
  ],
