...
export const pictures: IFixtureData<IFixturePicture> = {
  data: (client: HttpClient) => {
    return Observable.forkJoin(
      ...
      client.get('https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Localization/xview_l_train.json'),
      client.get('https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Localization/Test2/xview_test.json'),
      ...
      client.get('https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Localization/train_labeled.json'),
      client.get('https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Localization/test_labeled.json'),
      client.get('https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/Demo_output/demo_output_frames.json'),
    ).map((rawData: any[]) => {
      const [
        basePictures,
        voc0712Pictures,
      ...
      const ec19localizationTest = loadLocalizationPicturesFromJSON(ec19localizationTestRaw, 'ec19l_test', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Localization/Test2');
      ...
      const data: IFixturePicture[] = basePictures.concat(
        ...
        carsPictures,
        predictionSetPictures,
        loadPicturesFromJSON(CAD22kPictures, 'cad_22k', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/CAD_22k'),
        loadPicturesFromJSON(mStarPartialTrainPictures, 'mstar_partial_train', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/MSTAR_NEW_DATASET/Train'),
        loadPicturesFromJSON(mStarPartialTestPictures, 'mstar_partial_test', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/MSTAR_NEW_DATASET/Test'),
        loadPicturesFromJSON(ec19classificationTrain, 'ec19c_train', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Classification/Train'),
        loadPicturesFromJSON(ec19classificationTest, '1568189266412', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Classification/Test', true),
        loadPicturesFromJSON(ec19classificationTest, 'ec19c_test', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/EC19/Classification/Test'),
        ec19localizationTrain,
        ...
        loadPicturesFromJSON(mStarPartialTrainPictures, 'MSTAR_Train', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/MSTAR_NEW_DATASET/Train'),
        loadPicturesFromJSON(mStarPartialTestPictures, 'MSTAR_Test', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/MSTAR_NEW_DATASET/Test'),
        loadLocalizationPicturesFromJSON(xViewPictures, 'space_net', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/xView/cropped_data/images'),
        loadLocalizationPicturesFromJSON(dotaPictures, 'dota', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/DOTA/images'),
        loadLocalizationPicturesFromJSON(mosaicPictures, 'mosaic', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/mosaic/images'),
        ec19localizationTrainOld.map(_ => ({..._, albumId: 'ec19l_train_old'})),
        ec19localizationTestOld.map(_ => ({..._, albumId: 'ec19l_test_old'})),
        loadLocalizationPicturesFromJSON(demoOutputFrames, 'demo_output_frames', 'https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/Demo_output/frames'),
  ...
  [
    ...
    for (let i = 1; i <= count; i++) {
      data.push({
        ...
        'filepath': `https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/MSTAR_Chips/TEST_images/${label}_${i}.jpg`,
        'albumId': 'mstar_test',
        'filesize': 3096,
  ...
  [
    ...
    for (let i = 1; i <= count; i++) {
      data.push({
        ...
        'filepath': `https://s3.amazonaws.com/dev.deepcortex.ai/demo-data/MSTAR_Chips/TRAIN_images/${label}_${i}.jpg`,
        'albumId': 'mstar_train',
        'filesize': 3096,
