...
export const processes: IFixtureData<IProcess> = {
  data: [
    ...
    },
    {
      ...
      ownerId: 'ownerId1',
      target: IAsset.Type.EXPERIMENT,
      targetId: 'experiment6',
      status: IProcess.Status.RUNNING, // experimental
      progress: 0.1, // from 0 to 1
      estimate: 120, // experimental // seconds?
      created: '2016-01-01 01:05', // Date
      started: '2016-01-01 01:05', // Date
      completed: null, // Date
      jobType: IProcess.JobType.TABULAR_TRAIN,
    },
    {
      ...
      ownerId: 'ownerId1',
      target: IAsset.Type.EXPERIMENT,
      targetId: 'experiment7',
      status: IProcess.Status.RUNNING, // experimental
      progress: 0.03, // from 0 to 1
      estimate: 100, // experimental // seconds?
      created: '2016-01-01 01:05', // Date
      started: '2016-01-01 01:05', // Date
      completed: null, // Date
      jobType: IProcess.JobType.TABULAR_TRAIN,
